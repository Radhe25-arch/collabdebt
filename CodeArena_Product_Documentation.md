...
- **Styling:** Tailwind CSS (Custom Design System with colors like `sf-bg3`, `sf-teal`, `sf-purple`).
- **Icons:** Lucide-React
...
6. **Portfolio (`Portfolio`, `PortfolioProject`):** Links SkillForge users directly to their GitHub identities and synced repositories.
...
SkillForge distances itself from generic learning platforms by utilizing an extreme, premium, "developer-tooling" aesthetic:
...
---
*Generated by AI for the SkillForge Development Team.*
