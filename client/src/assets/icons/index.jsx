...
export const BoxIcon          = (p) => <Icon {...p} d={["M21 16.5v-9L12 3 3 7.5v9l9 4.5 9-4.5z", "M3 7.5L12 12l9-4.5", "M12 12v9"]} />;
...
export default {
  ...
  RefreshCw: RefreshCwIcon, Layers: LayersIcon, Box: BoxIcon, Infinity: InfinityIcon,
};
