    ...
    <div className="max-w-6xl mx-auto pb-16">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-5">
        ...
        <div className="xl:col-span-3 space-y-4">
          ...
          {lesson.quiz && !isCompleted && (
            <div className="bg-arena-purple/8 border border-arena-purple/20 rounded-2xl p-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-arena-purple/20 border border-arena-purple/30 flex items-center justify-center">
                  <Icons.Target size={15} className="text-arena-purple2" />
                </div>
                <div>
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-arena-purple font-mono text-xs font-bold text-white hover:bg-arena-purple/80 transition-all"
              >
                Take Quiz
              </button>
            </div>
        ...
        <div className="xl:col-span-2">
          <div className="bg-[#0a0a0a] border border-white/8 rounded-2xl overflow-hidden sticky top-20">
            ...
            <textarea
              ...
              className="w-full bg-transparent text-arena-teal font-mono text-xs p-4 outline-none resize-none border-0"
            ...
            <div className="border-t border-white/6">
              <button
                onClick={runCode}
                className="flex items-center gap-2 text-arena-teal hover:bg-arena-teal/5 transition-colors font-mono text-xs w-full px-4 py-3"
              >
      ...
      {showXP && (
        <div className="fixed bottom-8 right-8 z-50 animate-bounce">
          <div className="flex items-center gap-2 bg-arena-purple text-white px-5 py-3 rounded-2xl shadow-2xl border border-arena-purple/50">
            <Icons.Zap size={16} />
